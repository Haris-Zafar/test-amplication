...
@InputType()
class DemandListItemCreateNestedManyWithoutProductsInput {
...
export { DemandListItemCreateNestedManyWithoutProductsInput as DemandListItemCreateNestedManyWithoutProductsInput };
