...
export class CustomerResolverBase {
  ...
  @graphql.ResolveField(() => [CustomerProductPrice], { name: "customPrices" })
  async findCustomPrices(
    @graphql.Parent() parent: Customer,
    @graphql.Args() args: CustomerProductPriceFindManyArgs
  ): Promise<CustomerProductPrice[]> {
    const results = await this.service.findCustomPrices(parent.id, args);
  ...
  @graphql.ResolveField(() => [CustomerPayment], { name: "payments" })
  async findPayments(
    @graphql.Parent() parent: Customer,
