...
@InputType()
class PurchaseItemUpdateManyWithoutSupplierProductsInput {
...
export { PurchaseItemUpdateManyWithoutSupplierProductsInput as PurchaseItemUpdateManyWithoutSupplierProductsInput };
