...
@InputType()
class DemandListItemUpdateManyWithoutDemandListsInput {
...
export { DemandListItemUpdateManyWithoutDemandListsInput as DemandListItemUpdateManyWithoutDemandListsInput };
