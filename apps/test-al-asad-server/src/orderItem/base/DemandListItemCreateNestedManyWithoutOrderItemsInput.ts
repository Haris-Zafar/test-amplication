...
@InputType()
class DemandListItemCreateNestedManyWithoutOrderItemsInput {
...
export { DemandListItemCreateNestedManyWithoutOrderItemsInput as DemandListItemCreateNestedManyWithoutOrderItemsInput };
