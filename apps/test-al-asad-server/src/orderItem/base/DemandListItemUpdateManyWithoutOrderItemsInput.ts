...
@InputType()
class DemandListItemUpdateManyWithoutOrderItemsInput {
...
export { DemandListItemUpdateManyWithoutOrderItemsInput as DemandListItemUpdateManyWithoutOrderItemsInput };
